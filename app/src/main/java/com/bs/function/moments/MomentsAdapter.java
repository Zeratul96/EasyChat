...
class MomentsAdapter extends RecyclerView.Adapter<MomentsAdapter.ViewHolder>{
    ...
    MomentsAdapter(Context context, List<Map<String,String>> detailData) {
        this.context = context;
        this.detailData = detailData;
        userInfoList = DataBaseUtil.queryFriends();
    }

    public MomentsAdapter setData(List<Map<String,String>> detailData){
        this.detailData = detailData;
        userInfoList = DataBaseUtil.queryFriends();
        return this;
    }

    void setFavoriteList(List<Map<String,String>> list){favoriteList = list;}
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MainHandler.getInstance().post(new Runnable() {
                            @Override
                            public void run() {
                                MomentsAdapter.this.notifyItemChanged(holder.getAdapterPosition());
                            }
                        });
                    }
                }).start();
